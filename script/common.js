...
(function (doc, win) {
    ...
    recalc = function () {
      ...
      docEl.style.fontSize = 64 * (clientWidth / 750) + 'px';//我是以苹果6为基准的
    };
...
mui.plusReady(function(){
	plus.navigator.setStatusBarBackground( "#2da5ff" );
});
